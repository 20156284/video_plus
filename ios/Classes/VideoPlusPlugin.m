#import "VideoPlusPlugin.h"
#import "VideoPlusPlayer.h"
...
@implementation VideoPlusPlugin{
    NSObject<FlutterPluginRegistrar> *_registrar;
    NSMutableDictionary<NSNumber *, VideoPlusPlayer *> *_players;

    VideoPlusQueuingEventSink *_eventSink;
...
static VideoPlusPlugin *_instance = nil;
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
    ...
    VideoPlusPlayer *player = [[VideoPlusPlayer alloc] initJustTexture];
...
- (void)handleMethodCall:(FlutterMethodCall *)call
    ...
    if ([@"getPlatformVersion" isEqualToString:call.method]) {
        ...
        VideoPlusPlayer *players =  [[VideoPlusPlayer alloc] initWithRegistrar:_registrar];
        NSNumber *playerId = players.playerId;
        _players[playerId] = players;
        result(playerId);
    } else if ([@"releasePlayer" isEqualToString:call.method]) {
        NSNumber *pid = argsMap[@"pid"];
        VideoPlusPlayer *players = [_players objectForKey:pid];
        [players shutdown];
        if (players != nil) {
