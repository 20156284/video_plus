...
/** VideoPlusPlugin */
public class VideoPlusPlugin implements MethodCallHandler, FlutterPlugin, ActivityAware, VideoPlusEngine, VideoPlusVolume.VolumeKeyListener, AudioManager.OnAudioFocusChangeListener {
  ...
  final private SparseArray<VideoPlusPlayer> players = new SparseArray<>();
  ...
  public static void registerWith(PluginRegistry.Registrar registrar) {
    ...
    final VideoPlusPlayer player = new VideoPlusPlayer(plugin, true);
    player.setupSurface();
    player.release();
  }
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
    ...
    final VideoPlusPlayer player = new VideoPlusPlayer(this, true);
    player.setupSurface();
    player.release();
  ...
  public void onAttachedToActivity(ActivityPluginBinding binding) {
    ...
    if (mActivity.get() instanceof VideoPlusVolume.CanListenVolumeKey) {
      VideoPlusVolume.CanListenVolumeKey canListenVolumeKey = (VideoPlusVolume.CanListenVolumeKey) mActivity.get();
  ...
  private void initWithRegistrar(@NonNull PluginRegistry.Registrar registrar) {
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    ...
    switch (call.method) {
      ...
      case "init":
        ...
        break;
      case "createPlayer": {
        VideoPlusPlayer fijkPlayer = new VideoPlusPlayer(this, false);
        int playerId = fijkPlayer.getPlayerId();
        players.append(playerId, fijkPlayer);
      ...
      case "releasePlayer": {
        ...
        if (arg != null)
          pid = arg;
        VideoPlusPlayer fijkPlayer = players.get(pid);
        if (fijkPlayer != null) {
          fijkPlayer.release();
          players.delete(pid);
        }
